...
export default function Galrye() {
  ...
  return (
    <div className="relative overflow-hidden bg-white">
      <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48 mt-12">
          ...
          <div>
            <div className="mt-10 d-flex align-items-center">
              ...
              <span className="anyMated">
                ...
                <Link className="buttonGalry" href={`#`}>
                  <svg
                    height="36px"
                    width="36px"
                    viewBox="0 0 36 36"
                  ...
                  <span className="now">{t("a boost")}</span>
                  <span className="play">{t("Get")}!</span>
                </Link>
              <span className="anyMated">
